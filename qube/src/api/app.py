...
from qube.src.api.kate5controller import kate5Controller
from qube.src.api.kate5controller import kate5ItemController
from qube.src.api.versioncontroller import kate5ItemVersionController
...
api.add_resource(kate5ItemVersionController, '/v1/kate5/version')
api.add_resource(kate5Controller, '/v1/kate5')
api.add_resource(kate5ItemController, '/v1/kate5/<string:entity_id>')
