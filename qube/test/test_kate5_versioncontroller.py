...
HELLO_VERSION = "/v1/kate5/version"
...
class Testkate5VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_kate5_default_version(self, *args, **kwargs):
    ...
    def test_kate5_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
